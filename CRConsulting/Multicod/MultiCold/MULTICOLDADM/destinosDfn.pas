...
begin
  ...
  ComboBox1.Enabled := fDestinosDfn.Tag > 0;
    ...
    begin
      With repositorioDeDados do
        begin
          ...
          tDestinosDFN.Filter := 'CODREL = ' + QuotedStr(repositorioDeDados.cCodRel) + ' AND ' +
                                 'DESTINO = ' + QuotedStr(repositorioDeDados.cDestRel);
          tDestinosDFN.Open;

          if lowerCase(tDestinosDFN.Fields[2].AsString) = 'ftp' then
            RadioGroup1.ItemIndex := 1
          else
          if lowerCase(tDestinosDFN.Fields[2].AsString) = 'email' then
          ...
          if lowerCase(tDestinosDFN.Fields[5].AsString) = 'm' then
            RadioGroup2.ItemIndex := 1
          else
          if lowerCase(tDestinosDFN.Fields[5].AsString) = 'd' then
...
begin
  ...
  try
    try
      ...
      if Self.Tag = 0 then
        begin
          destino_ant := repositorioDeDados.cDestRel;

          repositorioDeDados.qDestinosDfnUPD.Parameters[ 0].Value := codRel2;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 1].Value := destino;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 2].Value := tipoDestino;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 3].Value := seguranca;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 4].Value := qtdPeriodos;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 5].Value := tipoPeriodo;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 6].Value := usuario;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 7].Value := senha;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 8].Value := dirExpl;
          repositorioDeDados.qDestinosDfnUPD.Parameters[ 9].Value := codRel;
          repositorioDeDados.qDestinosDfnUPD.Parameters[10].Value := destino_ant;
          repositorioDeDados.qDestinosDfnUPD.ExecSQL;
      ...
      if Self.Tag = 1 then
        begin
          repositorioDeDados.qDestinosDfnINS.Parameters[0].Value := codRel2;
          repositorioDeDados.qDestinosDfnINS.Parameters[1].Value := destino;
          repositorioDeDados.qDestinosDfnINS.Parameters[2].Value := tipoDestino;
          repositorioDeDados.qDestinosDfnINS.Parameters[3].Value := seguranca;
          repositorioDeDados.qDestinosDfnINS.Parameters[4].Value := qtdPeriodos;
          repositorioDeDados.qDestinosDfnINS.Parameters[5].Value := tipoPeriodo;
          repositorioDeDados.qDestinosDfnINS.Parameters[6].Value := usuario;
          repositorioDeDados.qDestinosDfnINS.Parameters[7].Value := senha;
          repositorioDeDados.qDestinosDfnINS.Parameters[8].Value := dirExpl;
          repositorioDeDados.qDestinosDfnINS.ExecSQL;
        end;
    except
      on e:exception do
        begin
          ...
          if repositorioDeDados.dbMulticold.InTransaction then
            repositorioDeDados.dbMulticold.RollbackTrans;
  ...
  with repositorioDeDados do
    begin
      try
        ...
        Query01.SQL.Add('SELECT CODREL FROM DESTINOSDFN WHERE CODREL = ' + QuotedStr(codRel));
        Query01.Open;
        ...
        if Query01.Eof then
          ...
          begin
            ...
            qDestinosDfnUPD.Parameters[10].Value := destino_ant;
