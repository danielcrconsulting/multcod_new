...
begin
  ...
  fFormulario.Tag := 0;
  repositorioDeDados.cCodRel  := DBGrid1.Columns.Items[0].Field.Text;
  repositorioDeDados.cDestRel := DBGrid1.Columns.Items[1].Field.Text;
...
begin
  ...
  if length(trim(strFiltro)) > 0 then
    ...
    if (tPesquisa.Fields[ColunaFiltro].DataType = ftSmallint)	or
