...
uses InvokeRegistry, Types, XSBuiltIns, UBuscaSequencial;
...
initialization
  ...
  RemTypeRegistry.RegisterXSClass(TBuscaSequencialDTO);
  RemTypeRegistry.RegisterXSClass(TResultadoBuscaSequencialDTO);
  RemTypeRegistry.RegisterXSClass(TQueryFacilDTO);
end.
