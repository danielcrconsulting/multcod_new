...
type
  ...
  private
    ...
    function    AddRFMFrameToPDF(DFFrame: TDFFrame) : string;
    function    AddRFMLineToPDF(DFLine, DFOldLine: TDFLine) : string;
    function    AddRFMLogoToPDF(DFLogo: TDFLogo; var w, h : Word) : string;
    function    AddRFMLogoXObjectExec(DFLogo : TDFLogo; imagenum : Integer) : string;
    function    AddRFMTextToPDF(DFText: TDFText) : string;
//    function    AddMltTextToPDF(MltText : TgArrPag) : string;
    function    AddRFMFieldsToPDF(DFField: TDFField) : string;
    ...
    procedure   SetMemStreamFromString(str: RawByteString; ms : TMemoryStream);
    function    GetStringFromMemStream(ms : TMemoryStream) : RawByteString;
...
procedure TDF6toPDFConverter.SetMemStreamFromString(str: RawByteString; ms : TMemoryStream);
begin
  ms.Clear;
...
function TDF6toPDFConverter.GetStringFromMemStream(ms: TMemoryStream): RawByteString;
begin
...
function TDF6toPDFConverter.AddRFMFrameToPDF(DFFrame: TDFFrame) : string;
var
...
function TDF6toPDFConverter.AddRFMLineToPDF(DFLine, DFOldLine: TDFLine) : string;
var phase: integer;
...
function TDF6toPDFConverter.AddRFMLogoToPDF(DFLogo: TDFLogo; var w, h : Word) : string;
var
  ptr : Pointer;
...
function TDF6toPDFConverter.AddRFMLogoXObjectExec(DFLogo : TDFLogo; imagenum : Integer) : string;
{var
  l, t, w, h : integer;}
begin
...
function TDF6toPDFConverter.AddRFMTextToPDF(DFText: TDFText) : string;
var
  fsize : integer;
...
function TDF6toPDFConverter.AddRFMFieldsToPDF(DFField: TDFField) : string;
var
