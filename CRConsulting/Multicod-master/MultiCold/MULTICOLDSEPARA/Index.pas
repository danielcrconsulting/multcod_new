...
Uses
  ...
  Dialogs, StdCtrls, Grids, SuTypGer, Zlib,   Buttons, DB, AvisoI, ExtCtrls,
...
Y := Y.Create;
Y.DecimalSeparator := ','; // Força o uso da vírgula como separador decimal nas operações aritméticas ...
...
//          Result := '0'+Result;
    ...
    If XCont >= 100000 Then
      begin
      Edit1.Text := IntToStr(BytesIn);
      Application.ProcessMessages;
      XCont := 0;
      end;
...
//      AssignFile(ArqOut, NomeArq + '.'+IntToStr(SeqInt));
      ...
      System.SetTextBuf(ArqOut,  BufOut);
...
//    End;
  ...
  If viRemoveS1SN = 'S' Then
    DeleteFile(PWideChar(ChangeFileExt(NomArq,'.PS'+IntToStr(SeqNomRel))));
...
{  RichEdit1.Lines.Add('');
  RichEdit1.Lines.Add('Iniciando o processo de alteração na tabela DFN ');
  RichEdit1.Lines.Add('Registro CodRel * (-999) ');
  FormGeral.QueryAux1.Close;
  FormGeral.QueryAux1.Sql.Clear;
  FormGeral.QueryAux1.Sql.Add('UPDATE DFN SET IDCOLUNA1 = ''1'', IDLINHA1 = ''1'', IDSTRING1 = ''X'', IDCOLUNA2 = ''1'', IDLINHA2 = ''1'', IDSTRING2 = ''Y'' WHERE CODREL = ''*''');
  FormGeral.QueryAux1.ExecSQL;

  RichEdit1.Lines.Add('Fim... ');
  ...
  While Not FormGeral.QueryAux1.Eof Do
    Begin
    ArrRel[I].CodRel := FormGeral.QueryAux1.FieldByName('CodRel').AsAnsiString;
    ...
    ArrRel[I].StrId1 := FormGeral.QueryAux1.FieldByName('IDString1').AsAnsiString;
    If FormGeral.QueryAux1.FieldByName('IDString2').AsAnsiString <> '' Then
      Begin
      ...
      ArrRel[I].StrId2 := FormGeral.QueryAux1.FieldByName('IDString2').AsAnsiString;
      End
    Else
      Begin
      ArrRel[I].Col2 := 0;
    ...
    If FormGeral.QueryAux1.FieldByName('CodGrupAuto').AsBoolean Then
      ...
      ArrRel[I].Tipo3 := FormGeral.QueryAux1.FieldByName('TipoGrupAuto').AsAnsiString;
      End
    Else
      Begin
      ...
      ArrRel[I].Tam3 := 0;
      End;
    ArrRel[I].SisAuto := FormGeral.QueryAux1.FieldByName('SisAuto').AsAnsiString;
  ...
  While Not FormGeral.QueryAux2.Eof Do
    ...
    ArrStrAuxAlfa[I].StrPsq := FormGeral.QueryAux2.FieldByName('CodAuxGrupo').AsAnsiString;
  ...
  While Not FormGeral.QueryAux2.Eof Do
    ...
    ArrStrAlfa[I].StrPsq := FormGeral.QueryAux2.FieldByName('CodGrupoAlfa').AsAnsiString;
    FormGeral.QueryAux2.Next;
    Inc(I);
    End;
  FormGeral.QueryAux2.Close;
  ...
  While Not FormGeral.QueryAux2.Eof Do
    Begin
    ArrSisAux[I].CodRel := FormGeral.QueryAux2.FieldByName('CodRel').AsAnsiString;
    ...
    ArrSisAux[I].Tipo := FormGeral.QueryAux2.FieldByName('Tipo').AsAnsiString;
    ArrSisAux[I].CodAux := FormGeral.QueryAux2.FieldByName('CodAux').AsAnsiString;
    FormGeral.QueryAux2.Next;
    Inc(I);
    End;
  FormGeral.QueryAux2.Close;
