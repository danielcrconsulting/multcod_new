...
uses SuTypGer, SuTypMultiCold, Types, SysUtils, System.Classes,
  ...
  type
    ...
    public
      class function ObterBuscaSequencial(multicoldManager: TMulticoldManager; tipo: TTipoBuscaSequencial) : TBuscaSequencial;
    end;
    ...
    public
      ...
      function  ExecutarBuscaSequencial(pagIni, pagFin, linIni, linFin, coluna: Integer; tipoBusca: TTipoBuscaSequencial; valorBusca: WideString) : TResultadoBuscaSequencial;
      function  ExecutarQueryFacil(pPesquisa: TListaPesquisa; pMensagem: String; var pResultado: TListaResultadoPesquisa): boolean;
...
begin
  // Obter a página original de forma forçada //
  if not Orig then
  begin
...
begin
 // @CAMORIM - Aqui será implementada a busca sequencial como no cliente. Depois de implementar,
 // será necessário refatorar para tentar organizar o código da rotina.
 // ***********************************************************************************************
 // 1 - Obter a página de número de acordo com o Objeto "buscaSequencial"
  ...
  try
    ...
    begin
      ...
      begin
        ...
        If Coluna = -1 Then
        Begin
          // BUSCA SEM ESPECIFICAÇÃO DE COLUNA //
        ...
        End Else
        Begin
          // BUSCA COM ESPECIFICAÇÃO DE COLUNA //
      ...
      Begin
        ...
        Except
          on e:exception do
            begin
              Result := false;
              raise DefinitionsException.Create('Erro carregando dados de segurança: '+e.Message);
            Exit;
            end;
          End; //Try
...
begin
  inherited Create(Format('Ocorreu um erro ao carregar as definiçoes! Message: %s', [message]));
end;
...
function TMulticoldManager.ExecutarBuscaSequencial(pagIni, pagFin, linIni, linFin, coluna: Integer; tipoBusca: TTipoBuscaSequencial; valorBusca: WideString): TResultadoBuscaSequencial;
var
...
class function TBuscaSequencialFactory.ObterBuscaSequencial(
  multicoldManager: TMulticoldManager; tipo: TTipoBuscaSequencial): TBuscaSequencial;
begin
  // Qdo existirem outras formas de busca implementadas, aqui que vou decidir qual
  // a forma de busca que será instanciada.
  case tipo of
    tbNormal:
...
begin
  ...
  if (ehEOF1) or (ehEOF2) then
    ...
    FPilha.push(j);  // Verificar se essa variável é usada em outro lugar!!!
    exit;
    end;
...
begin
  ...
  strPilha := FPilha.pop; // Pega o último
