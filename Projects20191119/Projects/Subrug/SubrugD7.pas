...
//  typBuffer = Array[1..BufCmpSize] Of Char;
  ...
  xArq = Class
         ...
         { Public declarations }
           ...
           Procedure xReadLn(Var xLinha : String);
           Procedure xWriteLn(Var xLinha : String);
...
Procedure xArq.xReadLn(Var xLinha : String);
...
Procedure xArq.xWriteLn(Var xLinha : String);
Begin
...
try
  ...
  hexToBin(pAnsiChar(lowerCase(str)),HexBuf,length(str) div 2); // Converte pra hexa
