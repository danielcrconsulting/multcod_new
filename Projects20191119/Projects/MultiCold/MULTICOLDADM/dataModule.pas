...
type
  TrepositorioDeDados = class(TDataModule)
    ...
    dbMulticoldEvento: TADOConnection;
    ...
    dbMulticoldLog: TADOConnection;
    logQuery: TADOQuery;
    Query05: TADOQuery;
    qGrupoRelNovo: TADOQuery;
    qAux1: TADOQuery;
    qRelaRelNovo: TADOQuery;
