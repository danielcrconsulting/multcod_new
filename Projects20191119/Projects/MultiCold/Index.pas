...
//      FormGeral.QueryAux1.Sql.Add('AND A.CODGRUPO = B.CODGRUPO');
      ...
      End;
    End
  Else If SistemaAutomatico THen
    Begin
...
//                        FormGeral.QueryAux2.FieldByName('CODGRUPO').AsAnsiString);
  ...
  FormGeral.InsereAtualizaCompila('+', FormGeral.QueryAux2.FieldByName('CodRel').AsAnsiString,
                                  CodigoDoSistema, CodGrupo,
