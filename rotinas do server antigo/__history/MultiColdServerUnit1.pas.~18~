...
Var
  ...
  StrAux : String;
  lResponse, lResponseIPX : TStringStream;
...
try
  ...
  FileMode := 0;
  lResponse.SaveToFile('c:\temp\a.dat');

  idHttp1.Get('http://localhost:8080/RELATORIO_20211017_132823.iapx', lResponse);
  lResponse.SaveToFile('c:\temp\a.iapx');

  FullPath := 'c:\temp\a.dat';
