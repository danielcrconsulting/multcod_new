...
function TFormGeral.RetornarContaAux(arquivo, contaaux: String): String;
begin
  result := OMetodosServer.ServerMethodsPrincipalClient.RetornarContaAux(arquivo, contaaux);
end;

function TFormGeral.RetornarContaCartao(arquivo, cartao, NArqCart: String): String;
begin
  result := OMetodosServer.ServerMethodsPrincipalClient.RetornarContaCartao(arquivo, cartao, NArqCart);
end;

function TFormGeral.RetornarContaCPF(arquivo, cpf: String): String;
begin
  result := OMetodosServer.ServerMethodsPrincipalClient.RetornarContaCPF(arquivo, cpf);
end;

function TFormGeral.RetornarContaEmpresa(arquivo: String; conta: Int64): String;
begin
